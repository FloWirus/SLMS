...
music_sync/
  ...
  gui/
    ...
    settings_dialog.py        templates, language, theme, libsoxr/TrackNoFix toggles, cover search regions
...
music_sync/
  ...
  gui/
    ...
    settings_dialog.py        szablony, język, motyw, przełączniki libsoxr/TrackNoFix, regiony wyszukiwania okładek
